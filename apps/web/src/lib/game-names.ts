...
const MAME_NAMES: Record<string, string> = {
  ...
  mmatrix: "마스 매트릭스",
  mpang: "마이티 팡",
  nwarr: "나이트 워리어즈: 다크스토커즈 리벤지",
  pzloop2: "퍼즐 루프 2",
  sfz2al: "스트리트 파이터 제로 2",
  redearth: "레드 어스",
  sfiii: "스트리트 파이터 III",
  sfiii2: "스트리트 파이터 III 2nd",
  bangbead: "뱅 비드",
  bjourney: "블루스 저니",
  breakrev: "브레이커즈 리벤지",
  bstars: "베이스볼 스타즈",
  ...
  ncommand: "닌자 코만도",
  neomrdo: "네오 Mr. Do!",
  samsh5fe: "사무라이 쇼다운 V 스페셜",
  sdodgeb: "슈퍼 닷지볼",
  trally: "쓰랏슈 랠리",
  twinspri: "트윙클 스타 스프라이츠",
  akatana: "아카이 카타나",
  alcon: "알콘",
  ddp3: "도돈파치 대왕생",
  ddpdfk: "도돈파치 대부활",
  ddpsdoj: "도돈파치 최대왕생",
  deathsml: "데스마일즈",
  dfkbl: "도돈파치 대부활 블랙 레이블",
  dsmbl: "데스마일즈 메가 블랙 레이블",
  espgal: "에스프가루다",
  espgal2: "에스프가루다 II",
  futari15: "무시히메사마 후타리 1.5",
  futaribl: "무시히메사마 후타리 블랙 레이블",
  grindstm: "그라인드 스토머",
  ibara: "이바라",
  ibarablk: "이바라 쿠로 블랙 레이블",
  ket: "케츠이: 인연지옥",
  mmpork: "머치 머치 포크!",
  mushisam: "무시히메사마",
  pinkswts: "핑크 스위츠",
