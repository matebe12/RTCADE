...
const EmulatorPlayer = forwardRef<HTMLDivElement, EmulatorPlayerProps>(function EmulatorPlayer(
  ...
  // ── FBNeo 라우팅: arcade/fbneo 코어 → FBNeoPlayer ──
  const useFBNeo = FBNEO_CORES.has(core);
  ...
  // FBNeo 경로: EmulatorJS 초기화 건너뛰고 FBNeoPlayer 렌더링
  if (useFBNeo) {
    // ROM URL을 백엔드 기준 절대경로로 생성
