  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {quickJoinRooms.length > 0 && (
        <div className="rounded-2xl border border-border/70 bg-card/80 px-4 py-3.5">
          ...
          <div className="flex flex-col gap-2">
            {quickJoinRooms.map((room) => (
              ...
              >
                ...
                <Button
                  size="sm"
                  className="h-7 shrink-0 px-2.5 text-[11px] rounded-full"
              ...
              >
                <div className="min-w-0 flex-1">
                  ...
                  <div className="mt-1 flex flex-wrap items-center gap-2 text-[10px] text-muted-foreground">
                    ...
                    <span>{opponent.playCount}번 플레이</span>
                  </div>
                </div>
              </div>
            ))}
